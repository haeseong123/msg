...
describe('ChatRoomParticipantController', () => {
    ...
    beforeEach(async () => {
        ...
        chatRoomParticipantController = module.get<ChatRoomParticipantController>(ChatRoomParticipantController);
    ...
    describe('채팅방에 다른 유저를 초대합니다.', () => {
        it('성공', async () => {
            ...
            jest.spyOn(chatRoomParticipantService, 'save').mockResolvedValue(savedParticipant);
    ...
    describe('채팅방을 나갑니다.', () => {
        it('성공', async () => {
            ...
            jest.spyOn(chatRoomParticipantService, 'remove').mockResolvedValue(leavedParticipant);
