...
describe('UserRelationService', () => {
  ...
  describe('관계를 생성합니다.', () => {
    ...
    beforeEach(() => {
      ...
      userRelationSaveDto = new UserRelationSaveDto(
        fromUserId,
        toUserId,
        UserRelationStatusEnum.FOLLOW,
      );
    ...
    it('성공', async () => {
      ...
      jest
        .spyOn(userRelationSaveDto, 'toEntity')
      ...
      jest
        .spyOn(fromUser, 'findRelationByToUserIdOrThrow')
        .mockImplementation((_toUserId) => relation);
  ...
  describe('관계의 status를 갱신합니다.', () => {
    it('성공', async () => {
      // Given
      const relationDto = new UserRelationDto(
        1,
        2,
        3,
        UserRelationStatusEnum.FOLLOW,
      ...
      const relation = UserRelation.of(
        relationDto.fromUserId,
        relationDto.toUserId,
        relationDto.status,
      );
      ...
      jest
        ...
        .mockImplementation(async (_fromUser) => fromUser);
